...
<div className="card-dos">
  ...
  <p className="text-dos">El precio varia dependiendo del paquete que elijas, para saber más
 te invitamos a crear una cuenta en Filmify </p>
</div>
...
<div className="card-dos-exc">
  ...
  <path d="M8 17h8M12 17v3" />
</svg>
  </div>
  <p className="title-dos-exc">¿Qué puedes ver?</p>
  <p className="text-dos-exc">Hay un repertorio bastante amplio de películas y series, sin embargo, depende de cada subscricion
  que puedes ver. Te invitamos a crear tu cuenta en Filmify y ver nuestros planes</p>
</div>
</div>
    )
}
